...
for j in range(num_assignments):
    ...
    assignment_averages.append(average)
...
print("Assignment Averages:")
for idx, avg in enumerate(assignment_averages, start=1):
    print(f"Assignment {idx}: {avg:.2f}")

# Print a newline to separate the sections
print()

# Print student averages
print("Student Averages:")
for idx, avg in enumerate(student_averages, start=1):
    print(f"Student {idx}: {avg:.2f}")